	...
	<div id="content" class="container">
		...
		<div class="section grid grid15">
			<a id="getOpinionList">
				...
				<p style="color: blue;">This API is used to get the list of
					opinions for an user.</p>
				<table border="1" style="border-collapse: collapse">
					...
					<tr>
						<td>getOpinionList</td>
						<td>.../opinion/getOpinionList</td>
						<td>POST</td>
